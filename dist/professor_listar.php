...
<html lang="pt-br">
	<?php
		...
		include "conexao.php";
		$sql      = "
		SELECT * FROM tb_usuarios WHERE fk_escola = '$fk_escola' AND perfil = '4'";
                                       ...
                                       <tbody>
                							<?php
                								...
                								foreach($alunos as $bolacha){
													...
													$excluir = "<center><a href='professor_excluir.php' title='Excluir $nome?'><img src='imagens/lixeira.png' width='30px'></a>
													<a href='professor_editar.php' title='Editar $nome?'><img src='imagens/editar.png' width='30px'></a></center>";
